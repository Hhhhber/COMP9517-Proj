...
from .data import YoloDetectDataset, get_transforms, collate_fn
...
def load_model(ckpt_path: str, num_classes: int, device: torch.device):
    ...
    model.roi_heads.score_thresh = 0.6       # 最佳阈值
...
if __name__ == "__main__":
    ...
    ap.add_argument("--ckpt", default="./outputs/frcnn/best.pth")
    ap.add_argument("--split", choices=["valid", "test", "train"], default="test")
    ap.add_argument("--out", default="./outputs/frcnn/preds_frcnn_test.json")
